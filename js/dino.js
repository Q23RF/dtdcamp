...
if (reversed == null) { reversed = false; }
	...
	// score
	this.score_text = new cjs.Text("00000", "24px 'Press Start 2P'", "#666666");
	this.score_text.name = "score_text";
	this.score_text.textAlign = "center";
	this.score_text.lineHeight = 35;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/dino_atlas_1.png?1656302906774", id:"dino_atlas_1"}
	],
	preloads: []
};
